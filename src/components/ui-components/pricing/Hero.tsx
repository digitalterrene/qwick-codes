...
export default function Hero() {
  return (
    <div
      style={{
        backgroundImage: `url('https://preline.co/assets/svg/examples/squared-bg-element.svg')`,
      }}
      className="relative bg-no-repeat bg-cover   bg-center  overflow-hidden before:absolute before:top-0 before:start-1/2"
    >
